                  ...
                  <table class="table">
                    <thead>
                      <tr class="text-nowrap">
                        <th>#</th>
                        <th><div class="border p-1 text-center bggris">Groupes</div></th>
                        <th><div class="border p-1 text-center bggris">Localit&eacute;</div></th>
                        <th><div class="border p-1 text-center bggris">IDB</div></th>
                        <th><div class="border p-1 text-center bggris">CLD</div></th>
                        <th><div class="border p-1 text-center bggris">THIMO</div></th>
                        <th><div class="border p-1 text-center bggris">TMI</div></th>
                        <th><div class="border p-1 text-center bggris">CERC</div></th>
                        <th><div class="border p-1 text-center bggris">MEDAC</div></th>
                        <th><div class="border p-1 text-center bggris">MGP</div></th>
                        <th><div class="border p-1 text-center bggris">Analyses</div></th>
                        <th><div class="border p-1 text-center bg-warning">MGP Hsens</div></th>
                        <th></th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                        <th scope="row">1</th>
                        <td><div class="border p-1 text-center">CTM_NU</div></td>
                        <td><div class="border p-1 text-center">NU</div></td>
                        <td><table width="100%"><tr><td>&nbsp;R</td><td>&nbsp;W</td><td>&nbsp;U</td><td>&nbsp;D</td></tr><tr><td align="center"><input class="form-check-input" type="checkbox" value="" id="" checked disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td></tr></table></td>
                        <td><table width="100%"><tr><td>&nbsp;R</td><td>&nbsp;W</td><td>&nbsp;U</td><td>&nbsp;D</td></tr><tr><td align="center"><input class="form-check-input" type="checkbox" value="" id="" checked disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td></tr></table></td>
                        <td><table width="100%"><tr><td>&nbsp;R</td><td>&nbsp;W</td><td>&nbsp;U</td><td>&nbsp;D</td></tr><tr><td align="center"><input class="form-check-input" type="checkbox" value="" id="" checked disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td></tr></table></td>
                        <td><table width="100%"><tr><td>&nbsp;R</td><td>&nbsp;W</td><td>&nbsp;U</td><td>&nbsp;D</td></tr><tr><td align="center"><input class="form-check-input" type="checkbox" value="" id="" checked disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td></tr></table></td>
                        <td><table width="100%"><tr><td>&nbsp;R</td><td>&nbsp;W</td><td>&nbsp;U</td><td>&nbsp;D</td></tr><tr><td align="center"><input class="form-check-input" type="checkbox" value="" id="" checked disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td></tr></table></td>
                        ...
                        <td><table width="100%"><tr><td>&nbsp;R</td><td>&nbsp;W</td><td>&nbsp;U</td><td>&nbsp;D</td></tr><tr><td align="center"><input class="form-check-input" type="checkbox" value="" id="" checked disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td></tr></table></td>
                        <td><table width="100%"><tr><td>&nbsp;R</td><td>&nbsp;W</td><td>&nbsp;U</td><td>&nbsp;D</td></tr><tr><td align="center"><input class="form-check-input" type="checkbox" value="" id="" checked disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td></tr></table></td>
                        <td><a href="{{url('paramgroupesmodifier')}}" type="button" class="btn btn-sm btn-danger">Modifier</a></td>
                      </tr>
                      <tr>
                        <th scope="row">2</th>
                        <td><div class="border p-1 text-center">CTIC_SK</div></td>
                        <td><div class="border p-1 text-center">SK</div></td>
                        <td><table width="100%"><tr><td>&nbsp;R</td><td>&nbsp;W</td><td>&nbsp;U</td><td>&nbsp;D</td></tr><tr><td align="center"><input class="form-check-input" type="checkbox" value="" id="" checked disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td></tr></table></td>
                        <td><table width="100%"><tr><td>&nbsp;R</td><td>&nbsp;W</td><td>&nbsp;U</td><td>&nbsp;D</td></tr><tr><td align="center"><input class="form-check-input" type="checkbox" value="" id="" checked disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td></tr></table></td>
                        <td><table width="100%"><tr><td>&nbsp;R</td><td>&nbsp;W</td><td>&nbsp;U</td><td>&nbsp;D</td></tr><tr><td align="center"><input class="form-check-input" type="checkbox" value="" id="" checked disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td></tr></table></td>
                        <td><table width="100%"><tr><td>&nbsp;R</td><td>&nbsp;W</td><td>&nbsp;U</td><td>&nbsp;D</td></tr><tr><td align="center"><input class="form-check-input" type="checkbox" value="" id="" checked disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td></tr></table></td>
                      ...
                      <tr>
                        <th scope="row">3</th>
                        <td><div class="border p-1 text-center">CTHIMO_IT</div></td>
                        <td><div class="border p-1 text-center">IT</div></td>
                        <td><table width="100%"><tr><td>&nbsp;R</td><td>&nbsp;W</td><td>&nbsp;U</td><td>&nbsp;D</td></tr><tr><td align="center"><input class="form-check-input" type="checkbox" value="" id="" checked disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td></tr></table></td>
                        <td><table width="100%"><tr><td>&nbsp;R</td><td>&nbsp;W</td><td>&nbsp;U</td><td>&nbsp;D</td></tr><tr><td align="center"><input class="form-check-input" type="checkbox" value="" id="" checked disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td></tr></table></td>
                        <td><table width="100%"><tr><td>&nbsp;R</td><td>&nbsp;W</td><td>&nbsp;U</td><td>&nbsp;D</td></tr><tr><td align="center"><input class="form-check-input" type="checkbox" value="" id="" checked disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td></tr></table></td>
                        <td><table width="100%"><tr><td>&nbsp;R</td><td>&nbsp;W</td><td>&nbsp;U</td><td>&nbsp;D</td></tr><tr><td align="center"><input class="form-check-input" type="checkbox" value="" id="" checked disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td></tr></table></td>
                      ...
                      <tr>
                        <th scope="row">4</th>
                        <td><div class="border p-1 text-center">CA_SU</div></td>
                        <td><div class="border p-1 text-center">SU</div></td>
                        <td><table width="100%"><tr><td>&nbsp;R</td><td>&nbsp;W</td><td>&nbsp;U</td><td>&nbsp;D</td></tr><tr><td align="center"><input class="form-check-input" type="checkbox" value="" id="" checked disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td></tr></table></td>
                        <td><table width="100%"><tr><td>&nbsp;R</td><td>&nbsp;W</td><td>&nbsp;U</td><td>&nbsp;D</td></tr><tr><td align="center"><input class="form-check-input" type="checkbox" value="" id="" checked disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td></tr></table></td>
                        <td><table width="100%"><tr><td>&nbsp;R</td><td>&nbsp;W</td><td>&nbsp;U</td><td>&nbsp;D</td></tr><tr><td align="center"><input class="form-check-input" type="checkbox" value="" id="" checked disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td></tr></table></td>
                        <td><table width="100%"><tr><td>&nbsp;R</td><td>&nbsp;W</td><td>&nbsp;U</td><td>&nbsp;D</td></tr><tr><td align="center"><input class="form-check-input" type="checkbox" value="" id="" checked disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td></tr></table></td>
                      ...
                      <tr>
                        <th scope="row">5</th>
                        <td><div class="border p-1 text-center">VBG_Team</div></td>
                        <td><div class="border p-1 text-center">SU</div></td>
                        <td><table width="100%"><tr><td>&nbsp;R</td><td>&nbsp;W</td><td>&nbsp;U</td><td>&nbsp;D</td></tr><tr><td align="center"><input class="form-check-input" type="checkbox" value="" id="" checked disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td></tr></table></td>
                        <td><table width="100%"><tr><td>&nbsp;R</td><td>&nbsp;W</td><td>&nbsp;U</td><td>&nbsp;D</td></tr><tr><td align="center"><input class="form-check-input" type="checkbox" value="" id="" checked disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td></tr></table></td>
                        <td><table width="100%"><tr><td>&nbsp;R</td><td>&nbsp;W</td><td>&nbsp;U</td><td>&nbsp;D</td></tr><tr><td align="center"><input class="form-check-input" type="checkbox" value="" id="" checked disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td></tr></table></td>
                      ...
                      <tr>
                        <th scope="row">6</th>
                        <td><div class="border p-1 text-center">Ethiq_Team</div></td>
                        <td><div class="border p-1 text-center">SU</div></td>
                        <td><table width="100%"><tr><td>&nbsp;R</td><td>&nbsp;W</td><td>&nbsp;U</td><td>&nbsp;D</td></tr><tr><td align="center"><input class="form-check-input" type="checkbox" value="" id="" checked disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td></tr></table></td>
                        <td><table width="100%"><tr><td>&nbsp;R</td><td>&nbsp;W</td><td>&nbsp;U</td><td>&nbsp;D</td></tr><tr><td align="center"><input class="form-check-input" type="checkbox" value="" id="" checked disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td></tr></table></td>
                        <td><table width="100%"><tr><td>&nbsp;R</td><td>&nbsp;W</td><td>&nbsp;U</td><td>&nbsp;D</td></tr><tr><td align="center"><input class="form-check-input" type="checkbox" value="" id="" checked disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td><td align="center"><input class="form-check-input" type="checkbox" value="" id="" disabled /></td></tr></table></td>
