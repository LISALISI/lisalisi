                ...
                <div class="row">
                    <div class="col-md-2 mb-1"><div class="border p-1 text-center">Actions</div></div>
                        <div class="col-md-7 mb-1">
                            <a href="{{url('oriente_plainte/'.$plainte_selected->Id)}}" onclick="return confirm('Etes-vous sûr de vouloir orienter ou annuler?')" class="btn btn-outline-primary" title="Orienter plainte">
                             ...
                             <a href="{{url('cloturer_plainte/'.$plainte_selected->Id)}}" onclick="return confirm('Etes-vous sûr de vouloir clôturer ?')" class="btn btn-outline-primary" title="Cl&ocirc;turer plainte">Cl&ocirc;turer</a>
                             @endif
                             @if ($plainte_selected->Statut_plainte_end=="cloture")
                                           ...
                                           <div class="col-md-12">
                                                ...
                                                <div class="col-md-12">
                                                            <div class="form-label-group">
                                                                    ...
                                                                    <textarea class="form-control" placeholder="..." id="Proposition_1" name="Proposition_1" autocomplete="off"></textarea>
                                                                             ...
                                                                             @foreach ($data_plainte_selected as $feedback_selected)
                                                                                ...
                                                                                @if ($feedback_selected->Feedback_plaingant =="insatisfait")
                                                                                    ...
                                                                                    <div class="form-label-group">
                                                                                        ...
                                                                                        <textarea class="form-control" placeholder="..." id="Proposition_2" name="Proposition_2" autocomplete="off"></textarea>
    ...
    <div class="modal-dialog modal-sm" role="document">
        ...
        <script>
            $(document).ready(function(){
                ...
                $('.searchTicket').keyup(function(){
                    ...
                    if(query != '')
                    {
                        ...
                        var key_search = "Ticket";
                        var table_name = "mgp_process";
                         $.ajax({
            ...
            if(ticketId != '')
                    {
                        var _token = $('input[name="_token"]').val();
                        var valueSearch = "Ticket";
                        var tableName = "mgp_process";
                         $.ajax({
            ...
            function requalifierPlainte(Id){
             ...
             function solutionPlainte(Id){
                $.get('/requalifier_plainte/'+Id, function(selectPlainteById){
                    ...
                    $("#Date_traitement").val(selectPlainteById.Date_traitement);
                    $("#Date_traitement2").val(selectPlainteById.Date_traitement2);
