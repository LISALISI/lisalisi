...
$('#nom_localite_ch').keyup(function(){
    ...
    if(query != '')
    {
        var _token = $('input[name="_token"]').val();
         $.ajax({
            url:"{{ route('autocomplete.fetchLocalite') }}",
            method:"POST",
                                    ...
                                    if(key_nom_localite_ch != '')
                                            {
                                                var _token = $('input[name="_token"]').val();
                                                $.ajax({
                                                    url:"{{ route('autocomplete.searchLocalite')  }}",
                                                    method:"POST",
                                                    data:{key_nom_localite_ch:key_nom_localite_ch, _token:_token},
                                                    success:function(result){
                                                        $.each(result.data_search_localite, function (key, value) {
