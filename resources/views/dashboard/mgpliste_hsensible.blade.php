                   ...
                   @if ($data_plainte)
                      ...
                      @foreach ($data_plainte as $plainte)
                            <tr>
                                ...
                                <td><a class="form-control btn btn-sm btn-info" href="{{url('show_plainte_hsensible/'.$plainte->Id_plainte)}}" style="cursor: pointer;">Afficher</a></td><td><a class="form-control btn btn-sm btn-warning" href="{{url('treat_plainte_hsensible/'.$plainte->Id_plainte)}}"  style="cursor: pointer;">Traiter</a></td>
                            </tr>
                       @endforeach
                    @endif
                        ...
                        $.ajax({
                            ...
                            if(data_plainte_filtrer.length >0){
                                ...
                                html +='<tr>\
                                        ...
                                        <td><a class="form-control btn-sm btn-info" style="cursor: pointer;" href="show_plainte_hsensible/'+data_plainte_filtrer[i]['Id_plainte']+'">Afficher</a></td><td><a class="form-control btn-sm btn-warning" style="cursor: pointer;" href="treat_plainte_hsensible/'+data_plainte_filtrer[i]['Id_plainte']+'">Traiter</a></td>\
                                        </tr>';
                                }
                            }else{
                                html +='<tr>\
                        ...
                        var tableName = "mgp_hsensible";
                         ...
                         $.ajax({
                            ...
                            data:{
                                ...
                                _token:_token},
                            success:function(result){
                            var data_plainte_filtrer = result.data_searched;
                            var html = '';
