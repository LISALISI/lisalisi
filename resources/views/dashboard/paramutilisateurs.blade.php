    ...
    <div class="row mt-2 mb-1">
        ...
        <div class="col-md-6 mb-1">
            <div class="p-1 border">
                ...
                <table width="100%" cellspacing="5" cellpadding="5">
                    <tr><td colspan="2"><h4><span class="badge badge-secondary">Ajouter au groupe</span></h4></td></tr>
                     <tr>
                            @if (session('success'))
                    ...
                    <tr>
                        <form action="{{route('affection_set')}}" method="GET">
                        <td>
                            @if (isset($data_groupe))
   ...
   $(document).ready(function (){
                                            $('#search_user').on('click', function () {
                                                ...
                                                if(key_nom_user_ch != '')
                                                        {
                                                            var _token = $('input[name="_token"]').val();
                                                            var valueSearch = "name";
                                                            var tableName = "users";
                                                        $.ajax({
                                                            url:"{{ route('valid_autocomplete_recherche')  }}",
                                                            method:"POST",
                                                            data:{
                                                                keyupId:key_nom_user_ch,
