                ...
                <div class="row">
                        ...
                        <div class="col-md-4">    
                                                    <h5 class="card-header">Role Table</h5>
                                                            <button type="button" class="float-left btn btn-sm btn-success" data-bs-toggle="modal" data-bs-target="#FormAddRole" title="Add New">
                                                                Nouveau Role
                                                            </button>
                        ...
                        {{-- table module --}}
                                <div class="col-md-4">    
                                                <h5 class="card-header">Module Table</h5>
                                                    <button type="button" class="float-left btn btn-sm btn-success" data-bs-toggle="modal" data-bs-target="#FormAddModule" title="Add New">
                                                        Nouveau Module
                                                    </button>
                                    <div class="table-responsive text-nowrap">
                                        <table class="table">
                        ...
                        {{-- / table module --}}
                            ...
                            <div class="col-md-4">    
                                                ...
                                                <button type="button" class="float-left btn btn-sm btn-success" data-bs-toggle="modal" data-bs-target="#FormAddDroit" title="Add New">
                                                    Nouveau Droit
                                                </button>
                                        <div class="table-responsive text-nowrap">
                                            <table class="table">
                ...
                <div class="row">
                        ...
                        <div class="col-md-6">    
                                                    <h5 class="card-header">User Table</h5>
                                                            <button type="button" class="float-left btn btn-sm btn-success" data-bs-toggle="modal" data-bs-target="#FormAddUser" title="Add New">
                                                                Nouvel utilisateur
                                                            </button>
                                    <div class="table-responsive text-nowrap">
                                        <table class="table">
