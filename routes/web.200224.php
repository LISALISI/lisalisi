...
Route::middleware([
    ...
    //  Route::get('oriente_plainte/{Id_plainte}', [MgpController::class,'getPlaintebyId']);
     ...
     Route::get('/paramgroupesmodifier',[ParamController::class,'viewparamgroupesmodifier'])->name('paramgroupesmodifier');
    ...
    Route::post('/affection_set', [RegisteredUserController::class, 'store_affection'])->name('affection_set');
